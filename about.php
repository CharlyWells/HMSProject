                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="text-sec padding-right-0">
                            <h5 >Welcome to the <span> DE PROJECT MATS </span> HMs </h5>
                            <ul class="row">
                              <li class="col-sm-6">
                                <h6> <i class="lnr  lnr-checkmark-circle"></i> EMERGENCY CASE</h6>
                                <p>DE project Mats HMSprovide reliable communications and improve public safety areas. </p>
                              </li>
                              <li class="col-sm-6">
                                <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                                <p>DE project Mats HMS  has licensed and qualified doctors! </p>
                              </li>
                              <li class="col-sm-6">
                                <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                                <p>DE project Mats HMS Supports Online Appointment. Check the appointment tab above. </p>
                              </li>
                              <li class="col-sm-6">
                                <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                                <p>DE project Mats HMS qualified doctors offers free counseling to their patients. </p>
                              </li>
                            </ul>
                        </div>
                    </div>
